...
const Hyperspeed = ({ effectOptions = DEFAULT_EFFECT_OPTIONS }) => {
  ...
  useEffect(() => {
    if (appRef.current) {
      ...
      appRef.current = null
      hyperspeed.current?.replaceChildren()
    }
    ...
    class App {
      constructor(container, options = {}) {
        ...
        // Some GPU/driver combos evict WebGL contexts once too many are live at
        // once (this page runs several background canvases). Losing the context
        // mid-init or mid-tick must not crash the tab — bail out quietly instead.
      ...
      init() {
        ...
        try {
          ...
          // WebGL context can be evicted by the browser/driver between renderer
          // creation and this point (too many live contexts, GPU reset, etc.).
          // Treat any failure here the same as a lost context and bail quietly.
          this.contextLost = true
          return
        }
